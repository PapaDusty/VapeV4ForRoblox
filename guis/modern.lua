...
-- Improved UI with smoother animations and modern feel
local mainapi = {
	Categories = {},
	GUIColor = {
		Hue = 0.46,
...
local uipallet = {
	...
	-- Enhanced tween info with smoother easing
	Tween = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
	PopupTween = TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
	SlideTween = TweenInfo.new(0.25, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out)
}
...
local function addTooltip(gui, text)
	...
	gui.MouseEnter:Connect(function(x, y)
		...
		tween:Tween(tooltip, uipallet.Tween, {
			Size = UDim2.fromOffset(tooltipSize.X + 10, tooltipSize.Y + 10)
		})
		tooltip.Text = text
		tooltipMoved(x, y)
	end)
	...
	ColorSlider = function(optionsettings, children, api)
		...
		function optionapi:Toggle()
			...
			if self.Rainbow then
				...
				tween:Tween(rainbow1, uipallet.Tween, {ImageColor3 = Color3.fromRGB(5, 127, 100)})
				task.delay(0.1, function()
					if not self.Rainbow then return end
					tween:Tween(rainbow2, uipallet.Tween, {ImageColor3 = Color3.fromRGB(228, 125, 43)})
					task.delay(0.1, function()
						if not self.Rainbow then return end
						tween:Tween(rainbow3, uipallet.Tween, {ImageColor3 = Color3.fromRGB(225, 46, 52)})
					end)
				end)
			else
				...
				tween:Tween(rainbow3, uipallet.Tween, {ImageColor3 = color.Light(uipallet.Main, 0.37)})
				task.delay(0.1, function()
					if self.Rainbow then return end
					tween:Tween(rainbow2, uipallet.Tween, {ImageColor3 = color.Light(uipallet.Main, 0.37)})
					task.delay(0.1, function()
						if self.Rainbow then return end
						tween:Tween(rainbow1, uipallet.Tween, {ImageColor3 = color.Light(uipallet.Main, 0.37)})
					end)
				end)
			end
		end
		...
		expandbutton.MouseEnter:Connect(function()
			tween:Tween(expand, uipallet.Tween, {ImageColor3 = color.Dark(uipallet.Text, 0.16)})
		end)
		expandbutton.MouseLeave:Connect(function()
			tween:Tween(expand, uipallet.Tween, {ImageColor3 = color.Dark(uipallet.Text, 0.43)})
		end)
	...
	Dropdown = function(optionsettings, children, api)
		...
		function optionapi:SetValue(val, mouse)
			...
			if dropdownchildren then
				...
				tween:Tween(dropdown, uipallet.SlideTween, {Size = UDim2.new(1, 0, 0, 40)})
		...
		button.MouseButton1Click:Connect(function()
			if not dropdownchildren then
				...
				tween:Tween(dropdown, uipallet.SlideTween, {Size = UDim2.new(1, 0, 0, 40 + (#optionsettings.List - 1) * 26)})
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				object.MouseButton1Click:Connect(function()
					...
					if ind then
						table.remove(self.ListEnabled, ind)
						tween:Tween(objectdot, uipallet.Tween, {BackgroundColor3 = color.Light(uipallet.Main, 0.37)})
						tween:Tween(objectdotin, uipallet.Tween, {BackgroundColor3 = color.Light(uipallet.Main, 0.02)})
					else
						table.insert(self.ListEnabled, v)
						tween:Tween(objectdot, uipallet.Tween, {BackgroundColor3 = optionsettings.Color})
						tween:Tween(objectdotin, uipallet.Tween, {BackgroundColor3 = optionsettings.Color})
					end
...
function mainapi:CreateGUI()
	...
	function categoryapi:CreateOverlayBar()
		...
		button.MouseButton1Click:Connect(function()
			...
			tween:Tween(window, uipallet.SlideTween, {
	...
	function categoryapi:CreateGUISlider(optionsettings)
		...
		expandbutton.MouseEnter:Connect(function()
			tween:Tween(expandicon, uipallet.Tween, {ImageColor3 = color.Dark(uipallet.Text, 0.16)})
		end)
		expandbutton.MouseLeave:Connect(function()
			tween:Tween(expandicon, uipallet.Tween, {ImageColor3 = color.Dark(uipallet.Text, 0.43)})
		end)
		expandbutton.MouseButton1Click:Connect(function()
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		dotsbutton.MouseEnter:Connect(function()
			if not moduleapi.Enabled then
				tween:Tween(dots, uipallet.Tween, {ImageColor3 = uipallet.Text})
			end
		end)
		dotsbutton.MouseLeave:Connect(function()
			if not moduleapi.Enabled then
				tween:Tween(dots, uipallet.Tween, {ImageColor3 = color.Light(uipallet.Main, 0.37)})
			end
		end)
...
function mainapi:CreateOverlay(categorysettings)
	...
	function categoryapi:Expand(check)
		...
		if self.Expanded then
			tween:Tween(window, uipallet.SlideTween, {Size = UDim2.fromOffset(window.Size.X.Offset, math.min(41 + windowlist.AbsoluteContentSize.Y / scale.Scale, 601))})
		else
			tween:Tween(window, uipallet.SlideTween, {Size = UDim2.fromOffset(window.Size.X.Offset, 41)})
		end
	end

	function categoryapi:Pin()
		self.Pinned = not self.Pinned
		tween:Tween(pin, uipallet.Tween, {ImageColor3 = self.Pinned and uipallet.Text or color.Dark(uipallet.Text, 0.43)})
	end
	...
	function categoryapi:Update()
		...
		if clickgui.Visible then
			...
			tween:Tween(window, uipallet.Tween, {
				Size = UDim2.fromOffset(window.Size.X.Offset, 0),
				BackgroundTransparency = 1
			})
			blur.Visible = false
			icon.Visible = false
...
function mainapi:CreateCategoryList(categorysettings)
			...
			if categorysettings.Profiles then
				...
				object.MouseButton1Click:Connect(function()
					...
					if ind then
						...
						table.insert(self.ListEnabled, v)
						tween:Tween(objectdot, uipallet.Tween, {BackgroundColor3 = categorysettings.Color})
						tween:Tween(objectdotin, uipallet.Tween, {BackgroundColor3 = categorysettings.Color})
					end
					categorysettings.Function()
				end)
				table.insert(self.Objects, object)
	...
	settings.MouseEnter:Connect(function()
		tween:Tween(settings, uipallet.Tween, {ImageColor3 = uipallet.Text})
	end)
	settings.MouseLeave:Connect(function()
		tween:Tween(settings, uipallet.Tween, {ImageColor3 = color.Light(uipallet.Main, 0.37)})
	end)
...
function mainapi:CreateLegit()
	...
	function legitapi:CreateModule(modulesettings)
		...
		back.MouseButton1Click:Connect(function()
			...
			tween:Tween(settingspane, uipallet.SlideTween, {
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		if tween.Tween then
			tween:Tween(notification, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
	...
	Function = function(hue, sat, val)
		for _, v in friends.Object.Children:GetChildren() do
			...
			if dot and dot.BackgroundColor3 ~= color.Light(uipallet.Main, 0.37) then
				tween:Tween(dot, uipallet.Tween, {BackgroundColor3 = Color3.fromHSV(hue, sat, val)})
				tween:Tween(dot.Dot, uipallet.Tween, {BackgroundColor3 = dot.BackgroundColor3})
			end
		end
...
local targetinfocolortoggle = targetinfoobj:CreateToggle({
	...
	Function = function(callback)
		...
		if callback then
			tween:Tween(targetinfobkg, uipallet.Tween, {BackgroundColor3 = Color3.fromHSV(targetinfocolor.Hue, targetinfocolor.Sat, targetinfocolor.Value)})
			tween:Tween(targetinfoshot, uipallet.Tween, {BackgroundColor3 = Color3.fromHSV(targetinfocolor.Hue, targetinfocolor.Sat, math.max(targetinfocolor.Value - 0.1, 0.075))})
			tween:Tween(targetinfohealthbkg, uipallet.Tween, {BackgroundColor3 = targetinfoshot.BackgroundColor3})
		else
			tween:Tween(targetinfobkg, uipallet.Tween, {BackgroundColor3 = color.Dark(uipallet.Main, 0.1)})
			tween:Tween(targetinfoshot, uipallet.Tween, {BackgroundColor3 = uipallet.Main})
			tween:Tween(targetinfohealthbkg, uipallet.Tween, {BackgroundColor3 = uipallet.Main})
		end
	end
})
targetinfocolor = targetinfoobj:CreateColorSlider({
	...
	Function = function(hue, sat, val)
		if targetinfocolortoggle.Enabled then
			tween:Tween(targetinfobkg, uipallet.Tween, {BackgroundColor3 = Color3.fromHSV(hue, sat, val)})
			tween:Tween(targetinfoshot, uipallet.Tween, {BackgroundColor3 = Color3.fromHSV(hue, sat, math.max(val - 0.1, 0))})
			tween:Tween(targetinfohealthbkg, uipallet.Tween, {BackgroundColor3 = targetinfoshot.BackgroundColor3})
		end
	end,
	Darker = true,
	...
	UpdateInfo = function(self)
		...
		if v then
			...
			if v.Health ~= lasthealth or v.MaxHealth ~= lastmaxhealth then
				...
				tween:Tween(targetinfohealth, TweenInfo.new(0.3, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
					Size = UDim2.fromScale(math.min(percent, 1), 1), BackgroundColor3 = Color3.fromHSV(math.clamp(percent / 2.5, 0, 1), 0.89, 0.75)
				})
				tween:Tween(targetinfohealthextra, TweenInfo.new(0.3, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
				...
				if lasthealth > v.Health and self.LastTarget == v then
					...
					tween:Tween(targetinfoshotflash, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						BackgroundTransparency = 1
					})
				end
				lasthealth = v.Health
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		...
		for i, v in VapeLabels do
			tween:Tween(v.Text, uipallet.Tween, {
				TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((textguigradient and i + 2 or i) * 0.025)) % 1)) or VapeLogoGradient.Color.Keypoints[2].Value)
			})
			if v.Color then
				tween:Tween(v.Color, uipallet.Tween, {BackgroundColor3 = v.Text.TextColor3})
			end
			if textguibackgroundtint.Enabled and v.Background then
				tween:Tween(v.Background, uipallet.Tween, {BackgroundColor3 = color.Dark(v.Text.TextColor3, 0.75)})
			end
		end
	end
	...
	for i, v in mainapi.Categories do
		if i == 'Main' then
			...
			for _, button in v.Buttons do
				if button.Enabled then
					tween:Tween(button.Object, uipallet.Tween, {
						TextColor3 = rainbow and Color3.fromHSV(mainapi:Color((hue - (button.Index * 0.025)) % 1)) or Color3.fromHSV(hue, sat, val)
					})
					if button.Icon then
						tween:Tween(button.Icon, uipallet.Tween, {ImageColor3 = button.Object.TextColor3})
					end
				end
			end
		end
		...
		if v.Type == 'CategoryList' then
			tween:Tween(v.Object.Children.Add.AddButton, uipallet.Tween, {
				ImageColor3 = rainbow and Color3.fromHSV(mainapi:Color(hue % 1)) or Color3.fromHSV(hue, sat, val)
			})
			if v.Selected then
				tween:Tween(v.Selected, uipallet.Tween, {
					BackgroundColor3 = rainbow and Color3.fromHSV(mainapi:Color(hue % 1)) or Color3.fromHSV(hue, sat, val)
				})
				tween:Tween(v.Selected.Title, uipallet.Tween, {
					TextColor3 = mainapi.GUIColor.Rainbow and Color3.new(0.19, 0.19, 0.19) or mainapi:TextColor(hue, sat, val)
				})
				tween:Tween(v.Selected.Dots.Dots, uipallet.Tween, {ImageColor3 = v.Selected.Title.TextColor3})
				tween:Tween(v.Selected.Bind.Icon, uipallet.Tween, {ImageColor3 = v.Selected.Title.TextColor3})
				tween:Tween(v.Selected.Bind.TextLabel, uipallet.Tween, {TextColor3 = v.Selected.Title.TextColor3})
			end
		end
	end
	...
	for _, button in mainapi.Modules do
		if button.Enabled then
			tween:Tween(button.Object, uipallet.Tween, {
				BackgroundColor3 = rainbow and Color3.fromHSV(mainapi:Color((hue - (button.Index * 0.025)) % 1)) or Color3.fromHSV(hue, sat, val)
			})
			tween:Tween(button.Object, uipallet.Tween, {
				TextColor3 = mainapi.GUIColor.Rainbow and Color3.new(0.19, 0.19, 0.19) or mainapi:TextColor(hue, sat, val)
			})
			...
			tween:Tween(button.Object.Bind.Icon, uipallet.Tween, {ImageColor3 = button.Object.TextColor3})
			tween:Tween(button.Object.Bind.TextLabel, uipallet.Tween, {TextColor3 = button.Object.TextColor3})
			tween:Tween(button.Object.Dots.Dots, uipallet.Tween, {ImageColor3 = button.Object.TextColor3})
		end
	...
	for i, v in mainapi.Overlays.Toggles do
		if v.Enabled then
			...
			tween:Tween(v.Object.Knob, uipallet.Tween, {
				BackgroundColor3 = rainbow and Color3.fromHSV(mainapi:Color((hue - (i * 0.075)) % 1)) or Color3.fromHSV(hue, sat, val)
			})
		end
	end

	if mainapi.Legit.Icon then
		tween:Tween(mainapi.Legit.Icon, uipallet.Tween, {ImageColor3 = Color3.fromHSV(hue, sat, val)})
	end
...
mainapi:Clean(notifications.ChildRemoved:Connect(function()
	for i, v in notifications:GetChildren() do
		if tween.Tween then
			tween:Tween(v, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
